...
const meta = {
  title: 'Shuriken UI/Base/Snack',
  // tags: ['autodocs'],
  render: (args) => Snack(args),
  argTypes: {
    label: {
      control: { type: 'text' },
      defaultValue: 'Iam a snack',
    },
    color: {
      control: { type: 'select' },
...
} satisfies Meta<SnackAttrs>

export default meta
type Story = StoryObj<SnackAttrs>
...
export const IconSmThree: Story = {
  name: 'Icon sm: Ex. 3',
  args: {
    label: 'Vue',
    color: 'default',
...
export const IconXsThree: Story = {
  name: 'Icon xs: Ex. 3',
  args: {
    label: 'Vue',
    color: 'default',
...
export const ImageOne: Story = {
  ...
  args: {
    label: 'Kendra W.',
    image: 'https://apollux.cssninja.io/img/avatars/10.svg',
  },
}

export const ImageTwo: Story = {
  name: 'Image: Ex. 2',
  args: {
    label: 'Anna L.',
    image: 'https://apollux.cssninja.io/img/avatars/24.svg',
  },
}

export const ImageThree: Story = {
  name: 'Image: Ex. 3',
  args: {
    label: 'Josh C.',
    image: 'https://apollux.cssninja.io/img/avatars/15.svg',
  },
}

export const ImageFour: Story = {
  name: 'Image: Ex. 4',
  args: {
    label: 'Maya P.',
    image: 'https://apollux.cssninja.io/img/avatars/2.svg',
  },
}
// #endregion

// #region Slot: image sm
export const ImageSmOne: Story = {
  name: 'Image sm: Ex. 1',
  args: {
    label: 'Kendra W.',
    color: 'default',
...
export const ImageSmThree: Story = {
  name: 'Image sm: Ex. 3',
  args: {
    label: 'Josh C.',
    color: 'default',
...
export const ImageSmFour: Story = {
  name: 'Image sm: Ex. 4',
  args: {
    label: 'Maya P.',
    color: 'default',
...
// #region Slot: image xs
export const ImageXsOne: Story = {
  name: 'Image xs: Ex. 1',
  args: {
    label: 'Kendra W.',
    color: 'default',
...
export const ImageXsThree: Story = {
  name: 'Image xs: Ex. 3',
  args: {
    label: 'Josh C.',
    color: 'default',
...
export const ImageXsFour: Story = {
  name: 'Image xs: Ex. 4',
  args: {
    label: 'Maya P.',
    color: 'default',
