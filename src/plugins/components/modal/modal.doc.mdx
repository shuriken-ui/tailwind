...
import { defaultModalConfig } from '.'

<Meta of={ModalStories} />

# Modal

Modals allow you to build popup dialogs that are useful for displaying information or prompting the user for input.
...
<div class="relative">
  <details class="relative bg-slate-50 border border-slate-200 rounded-lg p-4 [&>summary>svg]:open:-rotate-180">
    ...
    <div class="!mt-4">
      <pre >
        {JSON.stringify(defaultModalConfig, null, 2)}
      </pre>
    </div>
