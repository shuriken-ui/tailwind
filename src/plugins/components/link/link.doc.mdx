...
import { defaultLinkConfig } from '.'

<Meta of={LinkStories} />

# Link

Links allow you to navigate to another URL and are an essential part of every web application.
...
<div class="relative">
  <details class="relative bg-slate-50 border border-slate-200 rounded-lg p-4 [&>summary>svg]:open:-rotate-180">
    ...
    <div class="!mt-4">
      <pre >
        {JSON.stringify(defaultLinkConfig, null, 2)}
      </pre>
    </div>
