...
import * as PlaceholderPageStories from './placeholder-page.stories'
import { defaultPlaceholderPageConfig } from '.'

<Meta of={PlaceholderPageStories} />

# Placeholder

Placeholders allow you to fill in areas that don't have content yet.
...
<div class="relative">
  <details class="relative bg-slate-50 border border-slate-200 rounded-lg p-4 [&>summary>svg]:open:-rotate-180">
    ...
    <div class="!mt-4">
      <pre >
        {JSON.stringify(defaultPlaceholderPageConfig, null, 2)}
      </pre>
    </div>
