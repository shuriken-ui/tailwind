...
export { default as buttonAction } from './button-action'
...
export { default as dropdownDivider } from './dropdown-divider'
export { default as dropdownItem } from './dropdown-item'
export { default as dropdown } from './dropdown'
export { default as focus } from './focus'
export { default as fullscreenDropfile } from './fullscreen-dropfile'
export { default as heading } from './heading'
export { default as iconBox } from './icon-box'
export { default as inputFileRegular } from './input-file-regular'
...
export { default as placeload } from './placeload'
export { default as progressCircle } from './progress-circle'
export { default as progress } from './progress'
export { default as prose } from './prose'
export { default as radio } from './radio'
export { default as select } from './select'
export { default as slimscroll } from './slimscroll'
export { default as snack } from './snack'
export { default as switchBall } from './switch-ball'
export { default as switchThin } from './switch-thin'
...
export const components = mergePlugins([
  accordion,
  autocomplete,
  avatarGroup,
  avatar,
